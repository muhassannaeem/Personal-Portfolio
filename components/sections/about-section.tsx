...
export function AboutSection() {
  ...
  const timelineData = [
    ...
    },
    {
      ...
      title: "Intermediate",
      year: "2022",
      description: "Completed my FSC from F.G Sir Syed College The Mall, Rawalpindi.",
    },
    {
      icon: Code,
      title: "Bachealours",
  ...
  return (
    <section className="py-16 md:py-24 max-w-4xl mx-auto text-center">
      ...
      >
        With expertise spanning <span className="font-semibold text-foreground">Web Development</span> (React, Next.js,
        Node.js, Express.js), <span className="font-semibold text-foreground">Mobile App Development</span> (React
        Native, Kotlin), and <span className="font-semibold text-foreground">UI/UX Design</span>, I enjoy crafting clean,
        efficient, and user-friendly solutions. My approach emphasizes collaboration, continuous learning, and a
        commitment to delivering high-quality products that exceed expectations.
      </motion.p>
      ...
      >
        I am constantly learning and exploring new technologies to stay at the forefront of innovation. My goal is to
        contribute to projects that make a difference and to continuously grow as a developer and a problem-solver. When
        I'm not coding, you can find me exploring new tech trends, contributing to open-source, or enjoying a good book.
      </motion.p>
      ...
      <div className="relative before:absolute before:left-1/2 before:-translate-x-1/2 before:h-full before:w-0.5 before:bg-border before:top-0">
        {timelineData.map((item, index) => {
          ...
          return (
            ...
            >
              <div
                className={`w-1/2 pr-8 ${index % 2 === 0 ? "text-right" : "text-left order-2 pl-8"}`}
              >
