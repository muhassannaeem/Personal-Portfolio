    ...
    <section className="py-16 md:py-24">
      ...
      >
        ...
        <p className="text-lg text-muted-foreground leading-relaxed">
          With a blend of technical expertise and a keen eye for design, I deliver solutions that are not only robust
          and scalable but also delightful to use. I prioritize clear communication, agile methodologies, and a
          commitment to exceeding client expectations. Let's build something amazing together!
        </p>
      </motion.div>
    </section>
  )
